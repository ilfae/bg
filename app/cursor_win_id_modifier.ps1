...
$translation = @{
    ...
    "设置输出编码为 UTF-8" = "Установка кодировки вывода UTF-8"
    "颜色定义" = "Цвета"
    "配置文件路径" = "Пути к файлам"
    "PowerShell原生方法生成随机字符串" = "Генерация случайной строки средствами PowerShell"
    "修改Cursor内核JS文件实现设备识别绕过" = "Модификация JS-файлов ядра Cursor для обхода идентификации устройства"
    "Windows版Cursor应用路径" = "Путь к приложению Cursor для Windows"
    "未找到Cursor应用安装路径" = "Путь установки Cursor не найден"
    "请确认Cursor已正确安装" = "Убедитесь, что Cursor установлен правильно"
    "找到Cursor安装路径" = "Найден путь установки Cursor"
    "已生成新的设备标识符" = "Сгенерирован новый идентификатор устройства"
    "目标JS文件列表" = "Список целевых JS-файлов"
    "文件不存在" = "Файл не существует"
    "文件需要修改" = "Файл требует изменений"
    "文件已修改" = "Файл изменен"
    "所有JS文件已经被修改过，无需重复操作" = "Все JS-файлы уже изменены, повторное изменение не требуется"
    "正在关闭Cursor进程以进行文件修改" = "Завершение процессов Cursor для изменения файлов"
    
    # Меню и выбор действий
    "选择模式" = "Выбор режима"
    "请选择您要执行的操作" = "Выберите действие:"
    "仅修改机器码" = "Только изменить machine code"
    "重置环境+修改机器码" = "Сбросить окружение + изменить machine code"
    "执行机器码修改功能" = "Выполнить изменение machine code"
    "执行注入破解JS代码到核心文件" = "Внедрить JS-код в системные файлы"
    "跳过文件夹删除/环境重置步骤" = "Пропустить удаление папок/сброс окружения"
    "保留现有Cursor配置和数据" = "Сохранить текущие настройки Cursor и данные"
    "执行完全环境重置" = "Выполнить полный сброс окружения"
    "配置将丢失，请注意备份" = "Настройки будут потеряны, сделайте резервную копию"
    "这相当于当前的完整脚本行为" = "Это соответствует полному поведению скрипта"
    "请输入选择" = "Введите выбор"
    "您选择了" = "Вы выбрали"
    "执行流程" = "Порядок выполнения"
    "注意事项" = "Важные замечания"
    "不会删除任何文件夹或重置环境" = "Никакие папки не будут удалены, окружение не сбросится"
    "保留所有现有配置和数据" = "Сохраняются все текущие настройки и данные"
    "原配置文件会自动备份" = "Исходный файл конфигурации будет автоматически сохранен в резервную копию"
    "重要警告" = "Важное предупреждение"
    "配置将丢失" = "Настройки будут потеряны"
    "确认执行完全重置" = "Подтвердите выполнение полного сброса"
    "用户取消重置操作" = "Пользователь отменил операцию сброса"
    "无效选择" = "Неверный выбор"
    "请以管理员身份运行此脚本" = "Запустите скрипт от имени администратора"
    "请右键点击脚本，选择'以管理员身份运行'" = "Щелкните правой кнопкой мыши по скрипту и выберите 'Запуск от имени администратора'"
    ...
    "修复" = "Исправление"
    "安全" = "Безопасность"
    "核心功能" = "Основная функция"
    "说明" = "Описание"
    
    # Рекламные и информационные сообщения
    "Cursor 防掉试用Pro删除工具" = "Инструмент для предотвращения сброса пробной версии Cursor Pro"
    "关注公众号【煎饼果子卷AI】" = "Подпишитесь на канал [煎饼果子卷AI]"
    "一起交流更多Cursor技巧和AI知识" = "чтобы обмениваться знаниями о Cursor и ИИ"
    "脚本免费" = "Скрипт бесплатный"
    "关注公众号加群有更多技巧和大佬" = "Подпишитесь на канал и вступите в группу, чтобы получить больше советов и общаться с экспертами"
    "重要提示" = "Важное примечание"
    "本工具免费，如果对您有帮助，请关注公众号【煎饼果子卷AI】" = "Этот инструмент бесплатный, если он вам помог, подпишитесь на канал [煎饼果子卷AI]"
    "小小广告" = "Небольшая реклама"
    "出售CursorPro教育号一年质保三个月" = "Продажа образовательных аккаунтов CursorPro с гарантией 3 месяца"
    "有需要找我" = "Если нужно, обращайтесь"
    "WeChat：JavaRookie666" = "WeChat: JavaRookie666"
    
    # Процессы и операции
    "正在检查 Cursor 进程" = "Проверка процессов Cursor"
    "发现进程" = "Обнаружен процесс"
    "尝试关闭进程" = "Попытка завершить процесс"
    "进程已成功关闭" = "Процесс успешно завершен"
    "未发现进程运行" = "Процессы не обнаружены"
    "找到Cursor安装路径" = "Найден путь установки Cursor"
    "使用路径" = "Используется путь"
    "Cursor可执行文件不存在" = "Исполняемый файл Cursor не существует"
    "使用备用路径" = "Используется альтернативный путь"
    "无法找到有效的Cursor可执行文件" = "Не удалось найти действительный исполняемый файл Cursor"
    "正在启动Cursor" = "Запуск Cursor"
    "等待20秒让Cursor完全启动并生成配置文件" = "Ожидание 20 секунд для полного запуска Cursor и создания файла конфигурации"
    "配置文件已生成" = "Файл конфигурации создан"
    "等待5秒确保配置文件完全写入" = "Ожидание 5 секунд для гарантированной полной записи конфигурации"
    "配置文件未在预期时间内生成" = "Файл конфигурации не был создан в ожидаемое время"
    "可能需要手动启动Cursor一次来生成配置文件" = "Может потребоваться вручную запустить Cursor один раз для создания файла конфигурации"
    "正在关闭Cursor以进行配置修改" = "Завершение работы Cursor для изменения конфигурации"
    "Cursor重启流程完成" = "Процесс перезапуска Cursor завершен"
    "重启Cursor失败" = "Не удалось перезапустить Cursor"
    
    # Технические термины
    "设备标识符已成功劫持" = "Идентификатор устройства успешно подменен"
    "内核修改" = "Модификация ядра"
    "内核文件" = "Файлы ядра"
    "设备识别绕过" = "Обход идентификации устройства"
    "机器码" = "Machine code"
    "配置文件" = "Файл конфигурации"
    "试用状态" = "Пробный статус"
    "重置试用" = "Сброс пробной версии"
    "防掉试用" = "Защита от сброса пробной версии"
    "Pro功能" = "Функции Pro"
    
    # Логотип и графические элементы
    "======================================" = "======================================"
    "🚀   Cursor 防掉试用Pro删除工具          " = "🚀   Инструмент для предотвращения сброса пробной версии Cursor Pro"
    "📱  关注公众号【煎饼果子卷AI】 " = "📱  Подпишитесь на канал [煎饼果子卷AI]"
    "🤝  一起交流更多Cursor技巧和AI知识" = "🤝  Обменивайтесь советами по Cursor и знаниями по ИИ"
    "💡  [重要提示] " = "💡  [Важно] "
    "💰   [小小广告]  " = "💰   [Реклама]  "
    
    # Новые добавления из вывода
    "请输入选择 (1 或 2)" = "Введите выбор (1 или 2)"
    "是否继续执行？(输入 y 或 yes 继续，其他任意键退出)" = "Продолжить выполнение? (y или yes - продолжить, любая другая клавиша - выход)"
    "执行流程" = "Порядок выполнения"
    "您选择了：仅修改机器码" = "Вы выбрали: только изменение machine code"
    "原配置文件会自动备份" = "Исходный файл конфигурации будет автоматически сохранен в резервную копию"
}

# Улучшенная функция перевода с обработкой цветовых кодов
function Translate-Output {
    param([string]$text)
    
    # Регулярное выражение для поиска ANSI escape-последовательностей
    $ansiRegex = [regex]'\e\[[\d;]+m'
    
    # Разделяем текст на обычный текст и escape-последовательности
    $parts = $ansiRegex.Split($text)
    $matches = $ansiRegex.Matches($text)
    
    $result = ""
    for ($i = 0; $i -lt $parts.Count; $i++) {
        $part = $parts[$i]
        
        # Переводим только текстовые части (не escape-коды)
        if (-not [string]::IsNullOrEmpty($part)) {
            # Применяем все переводы
            $translatedPart = $part
            foreach ($key in $translation.Keys) {
                $translatedPart = $translatedPart -replace [regex]::Escape($key), $translation[$key]
            }
            $result += $translatedPart
        }
        
        # Добавляем escape-последовательность обратно
...
function Write-Host {
    ...
    $translated = Translate-Output $message
    
    # Сохраняем оригинальные параметры вывода
    $params = @{
        Object = $translated
        NoNewline = $NoNewline
    }
...
# ... (весь остальной оригинальный код скрипта)
